...
#include "ex2_demo_message/demo_msg.h"
#include <iostream>
#include <sstream>
...
//using namespace ex2_demo_message;
...

{
	...
	ros::Publisher number_publisher = node_obj.advertise<ex2_demo_message::demo_msg>("/demo_msg_topic",10);
